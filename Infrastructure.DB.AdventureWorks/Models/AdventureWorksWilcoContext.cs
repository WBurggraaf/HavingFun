...
public partial class AdventureWorksWilcoContext : DbContext
{
    public AdventureWorksWilcoContext()
    {
    }

    public AdventureWorksWilcoContext(DbContextOptions<AdventureWorksWilcoContext> options)
        : base(options)
    {
    }
